...
const Card = React.forwardRef<HTMLDivElement, CardProps>(
  ({ className, children, onClick, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        'sri-lanka-card px-7 py-3 rounded-xl border border-neutral-light-200 bg-white shadow-soft hover:shadow-medium transition-all duration-300',
        className
      )}
      onClick={onClick}
      {...props}
...
const DestinationCard = React.forwardRef<HTMLDivElement, DestinationCardProps>(
  ({ destination, className, ...props }, ref) => {
    ...
    <Card
      ref={ref}
      className={cn('sri-lanka-destination-card overflow-hidden group cursor-pointer', className)}
      {...props}
    >
      <div className="sri-lanka-destination-card-image relative h-48 overflow-hidden">
        {imageLoading && (
      ...
      <div className="sri-lanka-destination-card-content p-4">
        <div className="flex items-center justify-between mb-2">
          <h4 className="font-heading font-semibold text-neutral-dark-200 group-hover:text-primary transition-colors">
            {destination.name}
          </h4>
        ...
        <p className="text-sm text-neutral-dark-100 mb-3 line-clamp-2">
