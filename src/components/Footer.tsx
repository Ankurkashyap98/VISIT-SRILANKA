...
const Footer = ({ className }: FooterProps) => {
  ...
  return (
    <footer className={cn('sri-lanka-footer bg-white text-neutral-dark-200 border-t border-neutral-light-300', className)}>
      {/* Main Footer Content */}
      <div className="sri-lanka-footer-main max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Brand Section */}
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              <div className="sri-lanka-footer-logo relative w-10 h-10">
                <img 
              ...
              <div>
                <h3 className="text-xl font-bold mb-0" style={{ 
                ...
                <p className="text-sm text-neutral-dark-100 mb-0">Discover. Connect. Experience.</p>
              </div>
            </div>
          ...
          {/* Tourism Categories */}
          <div>
            <h4 className="text-lg font-heading font-semibold text-neutral-dark-200 mb-4">Explore Sri Lanka</h4>
          ...
          {/* Support & Safety */}
          <div>
            <h4 className="text-lg font-heading font-semibold text-neutral-dark-200 mb-4">Support & Safety</h4>
            <ul className="space-y-2">
          ...
          {/* Contact Information */}
          <div>
            <h4 className="text-lg font-heading font-semibold text-neutral-dark-200 mb-4">Contact Us</h4>
